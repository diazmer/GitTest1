...
:: Check if CTRLU_MBEAM_02.08.05.cdd exists in Output folder. 
if exist %outputDir%CTRLU_MBEAM_02.08.05.cdd (
   SET TARGETCDD="%outputDir%CTRLU_MBEAM_02.08.05.cdd"   
) else (
    :: will be used only during first Plugin execution 	
    SET TARGETCDD="%inputDir%CTRLU_MBEAM_02.08.05.cdd"
)
